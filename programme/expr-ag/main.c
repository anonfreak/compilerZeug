 ...
 * $Id: main.c,v 1.11 2014/12/14 14:50:14 vollmer Exp $
 */
...
int main (int argc, char *argv[])
{
   ...
   eval (TreeRoot);   /* attribute evaluator */

   printf ("Baum NACH dem Aufruf von eval()\n");
   DrawTree     (TreeRoot);

   printf ("Calculate        = %f\n", TreeRoot->program.Val);
   printf ("count EXPR nodes = %d\n", TreeRoot->program.Count);
   return (errors == 0)? 0 : 1;
}
